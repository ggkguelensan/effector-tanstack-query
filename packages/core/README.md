...
- A `Store` placed at the top level of `queryKey` triggers automatic refetch on change (a store nested inside an object/array key element is unsupported and throws)
